...
public class GetSeriesWatchStatesFromTraktJob : BaseJob
{
    ...
    public override string TypeName => "Get Series Watch States from Trakt";
    public override string Title => "Getting Series Watch States from Trakt";
    ...
    {
        _logger.LogInformation("Processing {Job} -> Series: {Name}", nameof(GetSeriesWatchStatesFromTraktJob), _seriesName);
        ...
        _helper.GetWatchStates(series);

        return Task.CompletedTask;
    }

    public GetSeriesWatchStatesFromTraktJob(TraktTVHelper helper, ISettingsProvider settingsProvider)
    {
        _helper = helper;
        _settingsProvider = settingsProvider;
    }

    protected GetSeriesWatchStatesFromTraktJob() { }
}
